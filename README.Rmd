...
shiny::fluidPage(
  ...
  shiny::fluidRow(
    shiny::tags$p(
      ...
      style="text-align:center; font-size:20px; border: 1px solid gold; background:#686877"
    )
  ),
  shiny::fluidRow(
    shiny::tags$p(
      ...
      shiny::tags$a(
        "here",
        href="https://fintech.meng.duke.edu/news/students-around-world-are-invited-sign-duke-fintech-trading-competition"
      )
    )
  ),
  shiny::fluidRow(
    shiny::column(
      4,
      shiny::tagList(
        shiny::tags$h2('2023 Cash Prizes', style="color:#beff00; font-weight:bold"),
