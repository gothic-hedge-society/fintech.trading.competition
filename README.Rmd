...
<p style = "text-align:center; font-size:20px; border: 1px solid gold; background:#686877">[Sign up](https://gothic-hedge-society.github.io/fintech.trading.competition/articles/sign_up.html) today for the 2023 Fall Competition!
</p>
...
shiny::fluidRow(
  shiny::column(
    4,
    shiny::tagList(
      shiny::tags$h2('2023 Cash Prizes'),
