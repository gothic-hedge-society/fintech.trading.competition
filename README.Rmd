...
shiny::fluidPage(
  ...
  shiny::fluidRow(
    shiny::tagList(
      shiny::tags$h3('04 Oct 2023: Registration closes'),
      shiny::tags$p(
      ...
      shiny::tags$p(
        "This is when we’ll begin keeping score. Use the week betwen 04 Oct and 11 Oct to get used to the Trader Workstation, interact on Discord, troubleshoot, etc."
      ),
