...
email_df = pd.read_csv(
    "https://docs.google.com/spreadsheets/d/1DDxG3aXqujOrS1s8"
    "-AMrO8hwhdU2dpbDyQFimagdAgU/edit?usp=drive_link&format=csv"
)



    'C:\\Users\\Jake\\Downloads\\duke_fintech_trading_competition_2022\\' + \
