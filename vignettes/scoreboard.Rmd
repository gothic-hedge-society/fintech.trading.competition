...
#           ) %>%
#           dplyr::select(Rank, trader_name, school, country, return) %>%
...
#           ) %>%
#           dplyr::select(Rank, trader_name, school, country, volatility) %>%
#           kableExtra::kbl(align="rccc") %>%
#           kableExtra::kable_minimal() %>%
#           kableExtra::row_spec(
#             0, color = "greenyellow"
...
#           ) %>%
#           dplyr::select(Rank, trader_name, school, country, alpha) %>%
#           kableExtra::kbl(align="rccc") %>%
#           kableExtra::kable_minimal() %>%
...
#           ) %>%
#           dplyr::select(Rank, trader_name, school, country, beta) %>%
#           kableExtra::kbl(align="rccc") %>%
#           kableExtra::kable_minimal() %>%
#           kableExtra::kable_styling(bootstrap_options = "condensed") %>%
#           kableExtra::row_spec(
...
#           intersect(
#             names(.),
#             trader_key$trader_name[which(trader_key$participating_S2022)]
#           )
#         ]
#       } %>%
...
# # Full Ranking
# standings %>%
#   dplyr::filter(trader_name %in% trader_key$trader_name[
