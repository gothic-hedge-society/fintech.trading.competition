...
```
<p class = "intro-text">Analysis of the 2022 Duke FINTECH Spring Trading Competition is posted here. This section is frequently updated and expanded, so be sure to check back often!</p>
...
shiny::tagList(
  shiny::fluidRow(
    shiny::tags$p(
      paste0("Last Updated: ", lubridate::with_tz(Sys.time(), tzone = "EST")),
      class = "last-updated"
    )  
  ),
  shiny::fluidRow(
