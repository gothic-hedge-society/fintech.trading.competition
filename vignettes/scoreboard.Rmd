...
shiny::tagList(
  ...
  shiny::fluidRow(
    shiny::tags$p(
      paste0(
        "These are the final results of the TRIAL PERIOD of the 2025 ",
        "Trading Competition. Scoring started last week on Thursday, 06 Feb, ",
        "so come back on Monday, 17 Feb to view the official ",
        "standings for the first week of the scored Competition!"
      ),
      class = "intro-text"
    )  
  ),
