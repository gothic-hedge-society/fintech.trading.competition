...
vignette: >
  %\VignetteIndexEntry{Scoreboard 2025}
...
shiny::tagList(
  ...
  shiny::fluidRow(
    shiny::tags$p(
      paste0(
        "These are the results posted during the TRIAL PERIOD of the 2025 ",
        "Trading Competition. Once account resets have processed and the ",
        "competition gets underway, you will find weekly standings updated ",
        "here every Monday. We will be extending this report page to ",
        "include more traders and more information in the coming weeks!"
      ),
      class = "intro-text"
    )  
  ),
...
### 1st Place: [`r sharpe_ordered_info$trader_name[1]`](`r sharpe_ordered_info$website[1]`)
`r sharpe_ordered_info$university[1]`

### 2nd Place: [`r sharpe_ordered_info$trader_name[2]`](`r sharpe_ordered_info$website[2]`)
`r sharpe_ordered_info$university[2]`

### 3rd Place: [`r sharpe_ordered_info$trader_name[3]`](`r sharpe_ordered_info$website[3]`)
`r sharpe_ordered_info$university[3]`

### 4th Place: [`r sharpe_ordered_info$trader_name[4]`](`r sharpe_ordered_info$website[4]`)
`r sharpe_ordered_info$university[4]`

### 5th Place: [`r sharpe_ordered_info$trader_name[5]`](`r sharpe_ordered_info$website[5]`)
`r sharpe_ordered_info$university[5]`

### 6th Place: [`r sharpe_ordered_info$trader_name[6]`](`r sharpe_ordered_info$website[6]`)
`r sharpe_ordered_info$university[6]`

### 7th Place: [`r sharpe_ordered_info$trader_name[7]`](`r sharpe_ordered_info$website[7]`)
`r sharpe_ordered_info$university[7]`

### 8th Place: [`r sharpe_ordered_info$trader_name[8]`](`r sharpe_ordered_info$website[8]`)
`r sharpe_ordered_info$university[8]`

### 9th Place: [`r sharpe_ordered_info$trader_name[9]`](`r sharpe_ordered_info$website[9]`)
`r sharpe_ordered_info$university[9]`

### 10th Place: [`r sharpe_ordered_info$trader_name[10]`](`r sharpe_ordered_info$website[10]`)
