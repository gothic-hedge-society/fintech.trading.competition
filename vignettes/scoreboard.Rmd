...
This past week was one for the storybooks -- maybe the most difficult week to be a trader in the Competition's entire four year history. The market corrections that took place caused major shakeup in the rankings and caught everyone unawares...

...except for one trader. Trader **161803**, who we'll call <a href='https://en.wikipedia.org/wiki/Phi'>'Phil'</a> for short, was hedged up. Phil and Phil alone is still standing with a positive Sharpe. Great job

There are still 2 months left, so it remains ANYONE's game to win, 
