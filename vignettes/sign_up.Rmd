...
```
This competition consists of four main components:

- This **website**, which communicates Competition information to participants,
  sponsors, and spectators.
- The **app**, which performs all the ranking and scoring calculations,
  handles registration and emailing, renders this website, stores data, etc. If 
  you aren't at Duke working on the code, then you probably won't need to 
  consider this component at all.
...
### Step 2: Join the official Competition Discord Channel 
...
official Competition Discord Server. The Discord server is new to the 
competition this year and we plan to leverage it to its fullest. Traders *must*
join the Discord -- even if you don't plan on using it (but you'll use it.
Trust us.).

**Follow the link and join the channel --
