...
Use this page to check on your registration! You can search for your tradername 
...
tradername. If you have more than one account, contact the admins on Discord 
...
DT::datatable(
  ...
  DT::formatStyle(
    columns = c('accountId', 'tradername', 'discord_username'), 
