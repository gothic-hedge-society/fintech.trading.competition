...
shiny::tagList(
  ...
  shiny::fluidRow(
    shiny::tags$p(
      paste0(
        "Below is the data from the first week of official trading! Congrats ",
...
```{r echo=FALSE}
sharpe_ordered_info$rank_display <-  purrr::map2(
  sharpe_ordered_info$trader_name,
  sharpe_ordered_info$website,
  function(tn, ws){
    if(ws == ""){
      return(tn)
    }
...
### 1st Place: `r sharpe_ordered_info$rank_display[1]`
`r sharpe_ordered_info$university[1]`

### 2nd Place: `r sharpe_ordered_info$rank_display[2]`
`r sharpe_ordered_info$university[2]`

### 3rd Place: `r sharpe_ordered_info$rank_display[3]`
`r sharpe_ordered_info$university[3]`

### 4th Place: `r sharpe_ordered_info$rank_display[4]`
`r sharpe_ordered_info$university[4]`

### 5th Place: `r sharpe_ordered_info$rank_display[5]`
`r sharpe_ordered_info$university[5]`

### 6th Place: `r sharpe_ordered_info$rank_display[6]`
`r sharpe_ordered_info$university[6]`

### 7th Place: `r sharpe_ordered_info$rank_display[7]`
`r sharpe_ordered_info$university[7]`

### 8th Place: `r sharpe_ordered_info$rank_display[8]`
`r sharpe_ordered_info$university[8]`

### 9th Place: `r sharpe_ordered_info$rank_display[9]`
`r sharpe_ordered_info$university[9]`

### 10th Place: `r sharpe_ordered_info$rank_display[10]`
